<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Diagnostic.Master" AutoEventWireup="true" CodeBehind="UnpaidBillReport.aspx.cs" Inherits="DiagnosticCenterBillMgtWebApp.UI.UnpaidBillReport" %>
...
<asp:Content ID="Content_body" ContentPlaceHolderID="ContentPlaceHolder_body" runat="server">
    <div class="display-table full-width-height margin-top-50">
        <div class="display-table-cell">
            <asp:Panel ID="Panel" GroupingText="Unpaid Bill Report" runat="server">
                <div class="row">
                        ...
                        <asp:Panel ID="recordPanel" runat="server" Visible="false">
                            <asp:GridView ID="GridView" ClientIDMode="Static" CssClass="table table-striped table-bordered table-hover table-responsive" AutoGenerateColumns="false" runat="server">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Bill Number" HeaderStyle-CssClass="text-center" HeaderStyle-Font-Bold="true">
                                        <ItemTemplate>
                                            <%#Eval("BillNo") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Contact No" HeaderStyle-CssClass="text-center" HeaderStyle-Font-Bold="true" ItemStyle-CssClass="text-right">
                                        <ItemTemplate>
                                            <%#Eval("Contact") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Patient Name" HeaderStyle-CssClass="text-center" HeaderStyle-Font-Bold="true" ItemStyle-CssClass="text-left">
                                        <ItemTemplate>
                                            <%#Eval("Name") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Bill Amount" HeaderStyle-CssClass="text-center" HeaderStyle-Font-Bold="true" ItemStyle-CssClass="text-right">
                                        <ItemTemplate>
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <rsweb:ReportViewer ID="ReportViewer" CssClass="width100" runat="server" ClientIDMode="Static" Visible="false" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                            <LocalReport ReportPath="Reports\UnpaidBillReport.rdlc"></LocalReport>
                        </rsweb:ReportViewer>
                    </div>
                </div>
            </asp:Panel>
