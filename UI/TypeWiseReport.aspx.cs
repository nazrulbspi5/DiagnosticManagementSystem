    ...
    public partial class TypeWiseReport : System.Web.UI.Page
    {
        ...
        protected void searchBox_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    List<ReportModel> report = new TestTypeManager().GetReport(startDate, endDate);
                    if (report == null)
                    {
        ...
        protected void pdfButton_Click(object sender, EventArgs e)
        {
            ...
            ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/TypeWiseReport.rdlc");
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + "Type-Wise-Report" + "." + extension);
