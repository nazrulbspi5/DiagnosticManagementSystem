<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Diagnostic.Master" AutoEventWireup="true" CodeBehind="TypeWiseReport.aspx.cs" Inherits="DiagnosticCenterBillMgtWebApp.UI.TypeWiseReport" %>
...
<asp:Content ID="Content_body" ContentPlaceHolderID="ContentPlaceHolder_body" runat="server">
    <div class="display-table full-width-height margin-top-50">
        <div class="display-table-cell">
            <asp:Panel ID="Panel" GroupingText="Type Wise Report" runat="server">
                <div class="row">
                        ...
                        <asp:Panel ID="recordPanel" runat="server" Visible="false">
                            <asp:GridView ID="GridView" ClientIDMode="Static" CssClass="table table-striped table-bordered table-hover table-responsive" AutoGenerateColumns="false" runat="server">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Test Type Name" HeaderStyle-CssClass="text-center" HeaderStyle-Font-Bold="true" ItemStyle-CssClass="text-left">
                                        <ItemTemplate>
                                            <%#Eval("Name") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <rsweb:ReportViewer ID="ReportViewer" CssClass="width100" runat="server" Visible="false" ClientIDMode="Static" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                            <LocalReport ReportPath="Reports\TypeWiseReport.rdlc"></LocalReport>
                        </rsweb:ReportViewer>
                    </div>
                </div>
            </asp:Panel>
