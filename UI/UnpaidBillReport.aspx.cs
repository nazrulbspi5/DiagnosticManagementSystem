    ...
    public partial class UnpaidBillReport : System.Web.UI.Page
    {
        ...
        protected void searchBox_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    List<ReportModel> report = new PatientManager().GetReport(startDate, endDate);
                    if (report == null)
                    {
        ...
        protected void pdfButton_Click(object sender, EventArgs e)
        {
            ...
            ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/UnpaidBillReport.rdlc");
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + "Unpaid-Bill-Report" + "." + extension);
